...
export function LoginCard({ error, next }: Props) {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-page px-4">
      <div className="w-full max-w-md rounded-lg border border-border-light bg-surface p-8 card-shadow">
        ...
        <div className="mb-8 text-center">
          ...
          <h1 className="mt-2 text-2xl font-bold text-text-primary">
            Welcome to Render Resume
          </h1>
          <p className="mt-2 text-sm leading-relaxed text-text-secondary">
            Continue with Google or GitHub to access your dashboard and resume
            builder.
          </p>
        </div>
        ...
        {message ? (
          <p
            className="mb-4 text-center text-sm text-error"
            role="alert"
          >
            {message}
          </p>
        ...
        <div className="flex flex-col gap-3">
          <form action="/api/auth/oauth/google" method="get">
            ...
            <button
              type="submit"
              className="inline-flex h-11 w-full items-center justify-center gap-2 rounded-md border border-border-light bg-surface px-4 text-sm font-semibold text-text-primary transition-colors hover:bg-surface-secondary"
            >
              <GoogleIcon />
